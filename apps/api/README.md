...
```bash
git clone https://github.com/MaFalana/HWC-PROJECT-2.git
cd HWC-PROJECT-2/apps/api
```
...
Deployment is handled by the monorepo's GitHub Actions workflows. See the [root README](../../README.md) for full CI/CD documentation.

- Images are pushed to GitHub Container Registry (ghcr.io)
- Azure Container Apps is updated automatically on push to `main`
...
- GitHub: https://github.com/MaFalana/HWC-PROJECT-2
